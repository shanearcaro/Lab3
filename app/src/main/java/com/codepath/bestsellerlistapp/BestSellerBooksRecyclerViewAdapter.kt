...
class BestSellerBooksRecyclerViewAdapter(
    ...
    inner class BookViewHolder(val mView: View) : RecyclerView.ViewHolder(mView) {
        ...
        val mBookAmazonURL: Button = mView.findViewById<View>(id.buy_button) as Button

        init {
            mBookTitle.setTypeface(null, Typeface.BOLD)
            mBookDescription.setTypeface(null, Typeface.NORMAL)
